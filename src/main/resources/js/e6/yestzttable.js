(function (global, factory) {
    ...
    var ta = new _DTable.DTable("yestzt").withiDisplayLength(30).withSort([[2, "desc"]], [1, 0]).preDrawCallback(tooblar, function () {//set tooblar and run fuction
    }).preAjaxReduce(ajaxCallback).preUrl('/gp/ztdx-yestZt').withAjax("codegen", function () {
        //filter
        var st = $('#st').val();
        return {
